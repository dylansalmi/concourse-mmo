...
namespace PageModel.SubSite.Pages
{
    ...
    public class AboutPage : BaseSubSitePage
    {
        ...
        /// The page url
        /// </summary>
        private static readonly string PageUrl = Config.GetValue("WebSiteBase").Trim('/') + "/static/BasicSite/About.html";

        public FluentElement AboutTable
        {
            get { return new FluentElement(this.testObject, By.CssSelector("#AboutTable"), "AboutTable"); }
        }
